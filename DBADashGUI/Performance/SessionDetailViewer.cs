...
namespace DBADashGUI.Performance
{
    ...
    public partial class SessionDetailViewer : Form
    {
        ...
        private static void StyleOverviewSections(DataGridView dgv)
        {
            using var headerFont = new Font(dgv.Font, FontStyle.Bold);
            foreach (DataGridViewRow gridRow in dgv.Rows)
            {
                ...
                {
                    gridRow.DefaultCellStyle.Font = new Font(dgv.Font, FontStyle.Bold);
